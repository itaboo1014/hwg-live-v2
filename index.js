$(function() {
    ...
    $(".header-2-schedule-btn").on("click", function() {
        $("html,body").animate({ scrollTop: $('#main-schedule').offset().top - 50 });
    });
    $(".header-2-recruit-btn").on("click", function() {
        $("html,body").animate({ scrollTop: $('#main-recruit').offset().top - 50 });
    });
